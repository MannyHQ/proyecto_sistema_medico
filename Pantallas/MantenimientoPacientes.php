            ...
            <div class="p-4">
                <form name="formulario" action="../Procesos/procesosPacientes.php" method="POST" class="row g-3 needs-validation was-validated">
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input name="cedula" onblur="buscar_paciente();"  type="text" class="form-control" id="cedula" minlength="11" maxlength="13" placeholder="" required>
                        <div class="valid-tooltip">
                            <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">
                            </font>
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input name="afiliado" type="text" class="form-control" id="afiliado" minlength="5" maxlength="13" required>
                        <div class="valid-tooltip">
                            <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">
                            </font>
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input name="telefono" type="tel" class="form-control" id="validationTooltip02" minlength="10" maxlength="15" placeholder="123-456-7890" required>
                        <div class="valid-tooltip">
                            <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">
                            </font>
