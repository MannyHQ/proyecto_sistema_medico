            ...
            <div class="p-4">
                <form name="formulario" action="../Procesos/procesosAseguradora.php" method="POST" class="row g-3 needs-validation was-validated">
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input name="nombre_aseguradora"   type="text" class="form-control" id="nombre_aseguradora" minlength="3" maxlength="40" required>
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input name="telefono" id="telefono" type="tel" class="form-control" minlength="3" maxlength="40" placeholder="123-456-7890" required>
                        <div class="valid-tooltip">
                            <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">
                            </font>
