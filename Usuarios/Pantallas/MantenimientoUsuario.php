    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card card-body">
                <form name="formulario" action="../Procesos/procesosUsuario.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for='tipo_usuario' class="form-check-label" for="flexCheckDefault"> Tipo usuario </label>
