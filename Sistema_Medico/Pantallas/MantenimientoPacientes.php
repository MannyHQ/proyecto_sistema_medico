...
<div class="container-fluid p-5">
    ...
    <div class="row">
        ...
        <div class="col-md-6 shadow-lg p-2 mb-5 bg-light  rounded">
            ...
            <div class="p-4">
                <form name="formulario" action="../Procesos/procesosPacientes.php" method="POST" class="row g-3 needs-validation was-validated" novalidate="">
                    <!--NOMBRE-->
                    ...
                    <div class="col-md-5 position-relative">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input name="correo" type="text" class="form-control" id="correo" aria-describedby="validationTooltipUsernamePrepend" required="">
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input name="telefono" type="text" class="form-control" id="validationTooltip02" minlength="10" maxlength="15" required="">
                        <div class="valid-tooltip">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">
                                </font>
