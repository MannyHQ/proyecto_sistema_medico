...
<div class="container-fluid p-5">
    <div class="row">
        ...
        <div class="col-md-6 shadow-lg p-2 mb-5 bg-light  rounded">
            ...
            <div class="p-4">
                <form name="formulario" action="../Procesos/procesosAseguradora.php" method="POST" class="row g-3 needs-validation was-validated" novalidate="">
                    <!--NOMBRE-->
                    ...
                    <div class="col-md-4 position-relative">
                        ...
                        <input name="telefono" id="telefono" type="text" class="form-control" minlength="3" maxlength="40">
                        <div class="valid-tooltip">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">
                                </font>
