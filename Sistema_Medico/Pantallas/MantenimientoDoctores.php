      ...
      <div class="p-4">
        <form name="formulario" action="../Procesos/procesosDoctores.php" method="POST" class="row g-3 needs-validation was-validated" >
          ...
          <div class="col-md-4 position-relative">
            ...
            <input name="email" type="email" class="form-control" id="validationTooltip02" required>
            <div class="valid-tooltip">
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">
                </font>
          ...
          <div class="col-md-4 position-relative">
            ...
            <input name="telefono" type="tel" class="form-control" minlength="10" maxlength="40" required>
            <div class="valid-tooltip">
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">
                </font>
          ...
          <div class="col-md-4 position-relative">
            ...
            <input name="celular" type="tel" class="form-control" id="validationTooltip02" minlength="10" maxlength="40">
            <div class="valid-tooltip">
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">
                </font>
