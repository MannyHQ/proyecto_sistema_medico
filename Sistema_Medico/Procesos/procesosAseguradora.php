...
if (isset($_POST['actualizarAseguradora'])) {
    ...
    $query = "UPDATE aseguradora set nombre_aseguradora = '$nombre', direccion_aseguradora = '$direccion', STATUS = '$ESTADO', correo_aseguradora = '$correo', telefono_aseguradora = '$telefono'
