...
<div class="col-md-6 shadow-lg p-2 mb-5 bg-light mx-auto  rounded">
    ...
    <div class="p-4">
        <form name="formulario" action="../Procesos/editarProcedimientos.php?ID_PROC=<?php echo $_GET['id_proc']; ?>" method="POST" class="row g-3 needs-validation was-validated" novalidate="">
            <!--NOMBRE-->
            ...
            <div class="col-md-8 position-relative">
                ...
                <input name="descripcion" value="<?php echo $DESCRIPCION; ?>" type="text" class="form-control" id="descripcion" minlength="11" maxlength="13" required="">
                <div class="valid-tooltip">
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">
                        </font>
