        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <img  id="img" class="navbar-brand navbar-left" src="img/Logo.png">
                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="panel-body">
                                    <input name="fechana" type="text" class="form-control" placeholder="Fecha Nacimiento">
                                </div>                            
                            </div>     
                        </div>
                        <div class="row" id="divbutn">
                            <div class="col-md-12">
                                ...
                                <button name="btn_modificar" class="btn btn-primary" type="submit" ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><a id="btmod" href="pantalla_modificar.php" target="_blank">Modificar</a></font></font></button>
                            </div>
                        </div>
                    </form>
                    <div class="col-md-3">
