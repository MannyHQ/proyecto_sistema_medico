...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6" class="row mt-3 g-3 needs-">
            ...
            <form action="../Procesos/registrar_paciente.php" method="post" class="needs-validation">
                ...
                <div class="col-4">
                    <div class="panel-body">
                        <?php
                        $con = mysqli_query($conex, "SELECT id_aseguradora,nombre FROM aseguradora");
                        if (!$con) {
                            die("Querry Failed");
                        }
                        ?>
                        <label for="ars" class="form-label">ARS</label>
                        <select name="ars"  id="ars" class="form-control" >
                            <?php
                            while ($fila = $con->fetch_assoc()) :
                                $id = $fila['id_aseguradora'];
                                $nombre = $fila['nombre'];
